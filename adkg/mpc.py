from adkg.progs.mixins.dataflow import (
    Share,
    ShareArray,
    ShareFuture,
    GFElementFuture,
    ...
    def open_share(self, share):
        ...
        def cb(r):
            ...
            if p is None:
                ...
                res.set_exception(
                    adkgError(f"Failed to open share with id {shareid}!")
                )
            else:
    ...
    def open_share_array(self, sharearray):
        ...
        def cb(r):
            ...
            if elements is None:
                ...
                res.set_exception(adkgError("Batch reconstruction failed!"))
            else:
    ...
    async def _run(self):
        ...
        if bgtask.done():
            ...
            if bg_exception is None:
                raise adkgError("background task finished before prog!")
            else:
                raise bg_exception
