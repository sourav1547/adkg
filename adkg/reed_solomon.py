from adkg.ntl import vandermonde_batch_evaluate, vandermonde_batch_interpolate
from adkg.ntl import gao_interpolate
...
class GaoRobustDecoder(RobustDecoder):
    ...
    #       see: https://github.com/initc3/adkg/pull/268
    def robust_decode(self, z, encoded):
        x = [self.point(zi).value for zi in z]
...
class DecodeValidationError(adkgError):
    pass
